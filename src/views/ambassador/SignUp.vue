            ...
            <form @submit.prevent="submit">
              ...
              <div class="form-row pt-3 d-flex flex-column flex-sm-row">
                ...
                <div class="col-sm-3 mb-3">
                  <label>Pais</label>
                  <select class="custom-select" v-model.trim="country">
                ...
                <div class="col-sm-3 mb-3">
                  <label>Ciudad</label>
                  <select class="custom-select" v-model.trim="city">
              ...
              <button type="submit" class="btn btn-primary mt-4" :disabled="$v.$invalid || !termsAndConditions">
